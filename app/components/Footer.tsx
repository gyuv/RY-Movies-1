...
export default function Footer() {
  return (
    <footer className="w-full border-t border-gray-800 bg-[#0B1437] backdrop-blur-xl relative overflow-hidden mt-20">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#060B24] border border-gray-800 text-[11px] font-mono text-gray-400 shadow-inner">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/?sort=popularity.desc" className="text-gray-400 hover:text-marquee transition-colors">
                  Trending Now
                </Link>
              </li>
              <li>
                <Link href="/?sort=vote_average.desc" className="text-gray-400 hover:text-marquee transition-colors">
                  Top Rated
                </Link>
              </li>
              <li>
                <Link href="/?sort=primary_release_date.desc" className="text-gray-400 hover:text-marquee transition-colors">
                  Latest Releases
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/?genre=28" className="text-gray-400 hover:text-marquee transition-colors">
                  Action
                </Link>
              </li>
              <li>
                <Link href="/?genre=35" className="text-gray-400 hover:text-marquee transition-colors">
                  Comedy
                </Link>
              </li>
              <li>
                <Link href="/?genre=18" className="text-gray-400 hover:text-marquee transition-colors">
                  Drama
                </Link>
              </li>
              <li>
                <Link href="/?genre=27" className="text-gray-400 hover:text-marquee transition-colors">
                  Horror & Thriller
                </Link>
              </li>
              {/* UPDATED: Points to your dedicated page route now */}
              <li>
                <Link href="/genres/erotic" className="text-gray-400 hover:text-marquee transition-colors flex items-center gap-2">
                  Erotic 
                  <span className="px-1.5 py-0.5 rounded bg-marquee/20 border border-marquee/50 text-marquee text-[9px] font-bold tracking-wider">
                    18+
                  </span>
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-2.5 mb-4">
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-[#060B24] border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:border-gray-500 transition-all"
              >
