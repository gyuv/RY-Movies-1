...
export const metadata: Metadata = {
  title: "BRTMovie — Your Streaming Hub",
  ...
  return (
    <html lang="en" className={`${display.variable} ${body.variable} ${mono.variable}`}>
      <body className="bg-[#141414]">
        ...
        {/* Updated Footer matching the design */}
        <footer className="bg-[#1a1a1a] border-t border-gray-800 mt-16 py-4">
          <div className="max-w-[1600px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400 font-medium">
            ...
            <div className="flex items-center gap-4 my-4 md:my-0">
              <span className="w-8 h-8 rounded-full border border-gray-500 flex items-center justify-center hover:bg-gray-700 cursor-pointer transition-colors">
                IG
              </span>
              <span className="w-8 h-8 rounded-full border border-gray-500 flex items-center justify-center hover:bg-gray-700 cursor-pointer transition-colors">
                G+
